<header class="p-3 text-bg-dark d-flex justify-content-between">
  <div class="dropdown">
    ...
    <ul class="dropdown-menu dropdown-menu-dark">
      ...
      <?php foreach ($categories as $category) : ?>
        <li><a class="dropdown-item" href="?page=category&id=<?= $category['id'] ?>"><?= $category['name'] ?></a></li>
      <?php endforeach; ?>
    </ul>
  </div>
  <div class="yt_logo">
    <a href="?page=/" class="d-flex mb-2 mb-lg-0 text-decoration-none justify-content-center">
      <svg viewBox="0 0 90 20" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon" style="pointer-events: none; display: inline-block; width: 60%; height: 60%;">
